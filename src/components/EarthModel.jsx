...
const Model = () => {
  const { scene } = useGLTF("./src/assets/earth.glb"); // Replace with the correct path to your .glb file
  ...
  return <primitive object={scene} scale={10} ref={earthRef} />; // Increased scale from 5 to 6
};
    ...
    <div className="welcome-container">
      ...
      <Canvas className="canvas">
        ...
        <OrbitControls
          ...
          maxDistance={15} // Limit maximum zoom out distance
          minDistance={1.5}  // Limit minimum zoom in distance to prevent too much closeness
        />
      </Canvas>
    </div>
  );
